...
var Loader = styled.div(_templateObject$2(), spin, function (props) {
...
var loadingAnimation = keyframes(["0%:{transform:rotate(0deg);opacity:0.5;}50%:{opacity:1;}100%:{transform:rotate(360deg);opacity:0.5;}"]);
...
function (_React$Component) {
  ...
  _createClass(Input$1, [{
    ...
    value: function render() {
      ...
      }), icon && !loading && React.createElement(Icon$2, {
        className: icon
