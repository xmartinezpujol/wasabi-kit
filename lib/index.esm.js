...
var Icon = styled.i(_templateObject(), function(props) {
  return {
...
var SelectorWrapper = styled.div(_templateObject$1(), fadeIn);
var LoaderContainer = styled.div(_templateObject2());
var Arrow = styled.i(_templateObject3(), COLOR_PALETTE.sashimi);
var ArrowNavPrev = styled.div(_templateObject4(), function(whiteNav) {
  return whiteNav
        ...
        value: function initCarousel(event, newProps) {
          ...
          if (fullWidthMode) {
            ...
            maxSlides = Math.trunc(
              (window.innerWidth >= 1430 ? 1430 : this.containerRef.current.offsetWidth) /
                (cardWidth + 6)
            );
          }
...
var HeroImage = styled.img(_templateObject$3());
var Carousel$1 = styled.div(_templateObject2$1(), function(props) {
  return props.height ? ''.concat(props.height, 'px') : '444px';
});
var Arrow$1 = styled.i(_templateObject3$1());
var ArrowNavPrev$1 = styled.div(_templateObject4$1());
var ArrowNavNext$1 = styled.div(_templateObject5$1());
...
var IconStyled = styled.i({}, function(props) {
  return {
...
var InputContainer = styled.div(_templateObject$4(), function(props) {
          ...
          this.setState(function(prevState) {
            return {
              togglePasswordStatus:
                prevState.togglePasswordStatus === 'password' ? 'text' : 'password'
            };
          });
        }
      },
...
var Text = function Text(props) {
  ...
  if (props.type.substring(0, 1) === 'h') {
    propOrDefault =
      typeof styles[props.type] !== 'undefined' ? props.type.substring(0, 2) : styles.p1;
  }

  if (props.type.substring(0, 1) === 'p') {
    propOrDefault =
      typeof styles[props.type] !== 'undefined' ? props.type.substring(0, 1) : styles.p1;
  }

  if (props.type.substring(0, 1) === 's') {
    propOrDefault =
      typeof styles[props.type] !== 'undefined' ? props.type.substring(0, 4) : styles.p1;
  }

  var TextGenerator = styled(propOrDefault)(styles[props.type]);
  return React.createElement(
    TextGenerator,
    {
      style: props.style
...
var View = styled.div(function(props) {
  return _objectSpread(
    {
...
export { Button, Card, Carousel, CarouselHero, Icon$1 as Icon, Input, Loader, Modal, Text, View };
